...
public class AirAdapter extends RecyclerView.Adapter<AirAdapter.ViewHolder> {
    ...
    AirAdapter(ArrayList<String> arrayListJudul, ArrayList<String> arrayListDeskripsi, ArrayList<Integer> arrayListGambar){
    ...
    public AirAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View V = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_air_adapter, parent,false);
        ViewHolder VH = new ViewHolder(V);
        return VH;
    }
    @Override
    public void onBindViewHolder(AirAdapter.ViewHolder holder, final int position) {
        ...
        holder.itemList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), AirMineral.class);
